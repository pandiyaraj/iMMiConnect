...
public extension Date {
    ...
    func stringToDate(dateStr : String , format : String = "dd-mmm-yyy") -> Date {
        let tempStr = dateStr.replacingOccurrences(of: "Z", with: "")
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
        let s = dateFormatter.date(from:tempStr)
        return s!
    }
    ...
    public var yesterday: Date {
        ...
        let yesterdayDate = Date().addingTimeInterval(-24*3600)
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd"
        let string_one = dateFormatter.string(from: yesterdayDate)
        let final_string = "\(string_one) 00:00:00"
        dateFormatter.dateFormat = "yyy-MM-dd HH:mm:ss"
        
        return dateFormatter.date(from: final_string) ?? Date()
        
    }
    
    
    //For getting startDay
    public var startDay: Date {
        
        let yesterdayDate = Date().addingTimeInterval(-12*3600)
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd"
        let string_one = dateFormatter.string(from: yesterdayDate)
        let final_string = "\(string_one) 00:00:00"
    ...
    public var today: Date {
        ...
        dateFormatter.dateFormat = "yyyy-MM-dd"
        let string_one = dateFormatter.string(from: yesterdayDate)
        let final_string = "\(string_one) 23:59:59"
        dateFormatter.dateFormat = "yyy-MM-dd HH:mm:ss"
    ...
    //For getting tommorrow
    public var tommorrow: Date {
